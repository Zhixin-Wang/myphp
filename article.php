...
<head>
	...
	<?php
		include 'article_p.php';
		session_start();
		$user = $_SESSION['user'];
		$a= new article_M($user);
	?>
</head>
...
<body>
	...
	<div class="main_a">
		<div class="head_infor">
	      <p style="margin-top: 0px;">日  志</p>
	    </div>
		<div>
			<div class="left_art" >
			<ul>
				<li id="m_bottom"><a href="?act=add">添加日志</a></li>
				<li id="m_bottom"><a href="?act=all">所有日志</a></li>
				<li id="m_bottom"><a href="?act=mya">我的日志</a></li>
				<?php $a -> t_type_show(); ?>
			</ul>
			</div>
			<div class="right_art">
				<?php
					if (count($_GET) == 0) {
						...
						switch ($_GET['act'])
						{
						  ...
						  break;
						  case 'updata':
						  	$a -> a_updata_show($_GET['id']);
						  break;
						  case 'article':
						  	$a -> article_show($_GET['id']);
						  break;
						  case 'type':
						  	$a -> type_show($_GET['type']);
						  break;
						  case 'mya':
						  	$a -> mya_show();
						  break;
